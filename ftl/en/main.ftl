...
Regression = Regression
    .hover = Regression analysis for estimating missing retention times.
...
Export = Export
    .hover = Export columns.
ForwardSelectivityFactor = Forward selectivity factor
    .short = Forward
    .hover = Selectivity factor of the current fatty acid to the preceding fatty acid.
BackwardSelectivityFactor = Backward selectivity factor
    .short = Backward
    .hover = Selectivity factor of the subsequent fatty acid to the current fatty acid.
