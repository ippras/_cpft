...
class ChromatogramApp:
    ...
    def update_style(self, event=None):
        ...
        self.ax.grid(False)
        self.ax.grid(visible=self.grid_var.get(), which='major', alpha=p['grid_alpha'], lw=p['grid_width'])
    ...
    def reset_all(self):
        ...
        # Сброс всех ползунков и полей ввода стиля
