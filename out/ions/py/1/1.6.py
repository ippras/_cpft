...
class ChromatogramApp:
    def __init__(self, root):
        ...
        self.default_style = {
            ...
            'spine_width': 1.0, 'tick_width': 1.0, 'tick_length': 4.0,
        ...
        self.style_widgets = {}
        self.label_entries = {}
        self.tick_widgets = {} # Для синхронизации шагов делений
    ...
    def setup_tab_style(self):
        ...
        rows = [("Заголовок", 'title_size', 8, 24), ("Оси", 'label_size', 8, 20), ("Числа", 'tick_size', 6, 16), 
                ...
                ("Деления (толщ)", 'tick_width', 0.1, 3), ("Деления (длина)", 'tick_length', 0, 15),
    ...
    def refresh_plots(self):
        ...
        # Принудительное обновление размера шрифта оси Y
        self.ax.yaxis.label.set_size(self.style_params['label_size'])
    ...
    def update_style(self, event=None):
        ...
        self.ax.tick_params(labelsize=p['tick_size'], width=p['tick_width'], length=p['tick_length'], which='both')
    ...
    # --- ВСПОМОГАТЕЛЬНЫЕ МЕТОДЫ (Файлы, Линии, Подписи) ---
