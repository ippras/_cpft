...
class ChromatogramApp:
    ...
    def create_control_window(self):
        ...
        self.ctrl_win.geometry("1100x900")
    ...
    def edit_helper_spin(self, idx, key):
        try:
            ...
            elif key == 'width': self.helper_lines[idx][key] = float(self.helper_lines[idx]['width_spin'].get())
    ...
    def refresh_plots(self):
        ...
        # Принудительно обновляем размер шрифта оси Y
    ...
    def reset_all(self):
        ...
        for it in self.plots_registry: it['line_width'] = self.style_params['line_width']
        self.reset_ticks(); self.update_ui_list(); self.refresh_plots()
