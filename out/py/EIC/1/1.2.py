...
class ChromatogramApp:
    ...
    def create_control_window(self):
        ...
        self.ctrl_win.geometry("1100x850")
    ...
    def setup_tab_helpers(self):
        ...
        cols = [("Тип", 30), ("Поз.", 60), ("Старт", 60), ("Конец", 60), ("Текст", 80), ("Метка%", 50), ("Шрифт", 50), ("Слой", 70)]
    ...
    def update_helper_ui(self):
        ...
        for i, h in enumerate(self.helper_lines):
            ...
            # Исправленный цикл создания Spinbox (без shadowing переменной f)
    ...
    def edit_helper_spin(self, idx, key):
        try:
            ...
            self.helper_lines[idx][key] = spin_val / 100.0 if key == 'label_pos' else spin_val
            self.refresh_plots()
        except: pass
