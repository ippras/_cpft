        ...
        match (row, column) {
            ...
            (1, column) => {
                ...
                ui.heading(ui.localize("OnsetTemperature.abbreviation"))
                    .on_hover_ui(|ui| {
                        ui.label(ui.localize("OnsetTemperature.hover"));
                    });
            }
            // (1, bottom::ONSET) => {
            //     ui.heading(ui.localize("onset-temperature.abbreviation"))
            //         .on_hover_ui(|ui| { ui.label(ui.localize("onset-temperature")); });
            // }
            // (1, bottom::STEP) => {
            //     ui.heading(ui.localize("temperature-step.abbreviation"))
            //         .on_hover_ui(|ui| { ui.label(ui.localize("temperature-step")); })
            //         .on_hover_ui(|ui| { ui.label(ui.localize("temperature-step.hover")); });
            // }
            // (1, bottom::FROM) => {
            ...
            //         .on_hover_ui(|ui| { ui.label(ui.localize("retention-time-distance")); })
            //         .on_hover_ui(|ui| { ui.label(ui.localize("retention-time-distance.hover")); });
            // }
            // (1, bottom::ECL) => {
            //     ui.heading(ui.localize("equivalent-chain-length-distance.abbreviation"))
            //         .on_hover_ui(|ui| { ui.label(ui.localize("equivalent-chain-length-distance")); })
            //         .on_hover_ui(|ui| { ui.label(ui.localize("equivalent-chain-length-distance.hover")); });
            // }
            // (1, bottom::EUCLIDEAN) => {
            //     ui.heading(ui.localize("euclidean-distance.abbreviation"))
            //         .on_hover_ui(|ui| { ui.label(ui.localize("euclidean-distance")); })
            //         .on_hover_ui(|ui| { ui.label(ui.localize("euclidean-distance.hover")); });
            // }
            // (1, bottom::ALPHA) => {
            //     ui.heading(ui.localize("alpha.abbreviation"))
            //         .on_hover_ui(|ui| { ui.label(ui.localize("alpha")); })
            //         .on_hover_ui(|ui| { ui.label(ui.localize("alpha.hover")); });
            // }
            _ => {}
        }
    }
