...
// pub(crate) static AGILENT: LazyLock<HashedMetaDataFrame> = ron!("Agilent[2.14].2026-04-10.ron");
pub(crate) static AGILENT: LazyLock<HashedMetaDataFrame> = ron!("Agilent[3.11].2026-05-06.ron");
