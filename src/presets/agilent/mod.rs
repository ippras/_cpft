...
pub(crate) static AGILENT_3_14: LazyLock<HashedMetaDataFrame> =
    ron!("Agilent[3.14].2026-05-06.ron");
pub(crate) static AGILENT: LazyLock<HashedMetaDataFrame> = ron!("Agilent[3.17].2026-05-13.ron");
